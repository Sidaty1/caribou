...
class ControlFrame(Sofa.Core.Controller):
    ...
    def CreateGraph(self, root):
        ...
        beam_q1 = meshio.read("/home/sidaty/Desktop/external_plugins/caribou/Validation/meshes/beam_q1.vtu")
        ...
        self.sofa_mo = sofa_node.addObject('MechanicalObject', name="mo", position=beam_q1.points.tolist())
        ...
        self.fenics_mo = fenics_node.addObject('MechanicalObject', name="mo", position=beam_q1.points.tolist())
