...
class ControlFrame(Sofa.Core.Controller):
    ...
    def CreateGraph(self, root):
        ...
        beam_p2 = meshio.read("/home/sidaty/Desktop/external_plugins/caribou/Validation/meshes/beam_p2.vtu")
        ...
        self.sofa_mo = sofa_node.addObject('MechanicalObject', name="mo", position=beam_p2.points.tolist())
        sofa_node.addObject('CaribouTopology', name='topology', template='Tetrahedron10', indices=indices.tolist())
        ...
        self.fenics_mo = fenics_node.addObject('MechanicalObject', name="mo", position=beam_p2.points.tolist())
        fenics_node.addObject('CaribouTopology', name='topology', template='Tetrahedron10', indices=indices.tolist())
